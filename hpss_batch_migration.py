...
class MigrateJob:
    ...
    def startMigrate(self):
        ...
        for vvlist in vvs:
            ...
            if len(files) > 0:
                ...
                filelistnum += 1
                infilename = "{}/hpss_batch_migration.{}.list".format(os.getcwd(), filelistnum)
    ...
    def startDestChecksumming(self):
        ...
        values = []
        with multiprocessing.Pool(self.checksum_threads) as p:
...
def main():
    ...
    if not args.dry_run:
        reportfilename = "hpss_batch_migration_report_{}.json".format(int(time.time()))
